      ...
      <v-layout align-center row wrap>
        <v-flex xs12 sm12 md8 lg8 align-center offset-md2 offset-lg2 class="py-5">
          ...
          >
            ...
            <v-card-text>
              <div v-for="result in results[index]" :key="result.name">
                <v-avatar size="50" class="grey lighten-2">
                <img :src="result.profilePicture" v-if="result.profilePicture">
